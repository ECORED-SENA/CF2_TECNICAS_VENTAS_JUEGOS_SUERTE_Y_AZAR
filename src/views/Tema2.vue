...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    .titulo-principal.color-acento-contenido(data-aos="zoom-in-left")
      .titulo-principal__numero
        span 2
      h1 Estrategia de ventas

    p.mb-4 La planificación y proyección de toda acción requiere diversos factores, es importante tanto para un vendedor como para una empresa tener claridad sobre la siguiente información:
      ...
      .col-lg-10
        .row.align-items-center.justify-content-center.mb-5  
          ...
          .col-lg-6.mb-3(data-aos="fade-left") 
            img.mt-5(src='@/assets/curso/images/tema2/img_2.svg'  alt='')

    p.mb-3 Estos interrogantes hacen parte de la estrategia, de allí se desprenden variables como:
  ...
  .container.bg-white.px-md-5.px-3.py-2.container-top.fondo-3.mg-top-2.mb-0.cs
    ...
    p.mb-0 A la hora de estructurar una estrategia se recomienda definir cinco elementos importantes que tendrán por finalidad lograr el incremento de las ventas:
      ...
      .col-lg-10
        .bloque-texto-g.color-custom-3.p-3.p-sm-4.p-md-5.mb-5.d-none.d-lg-block
          ...
          .bloque-texto-g__texto.p-5.m-right(data-aos="fade-left")
            p.mb-0 Como se mencionó anteriormente, las estrategias de venta no son permanentes, ni inmodificables, estas siempre van a variar según sea la clase de producto, las temporadas, entre otras razones, es por ello que a continuación se mencionan acciones importantes dentro de la estrategia de venta.
      ...
      .row.m-4.align-items-center.justify-content-between
        .col-lg-9(data-aos="fade-right")
          .bloque-texto-a__texto.p-5.my-5
            p Como se mencionó anteriormente, las estrategias de venta no son permanentes, ni inmodificables, estas siempre van a variar según sea la clase de producto, las temporadas, entre otras razones, es por ello que a continuación se mencionan acciones importantes dentro de la estrategia de venta.
        .col-lg-3.mb-3.mb-lg-0(data-aos="fade-left")
          figure
            img(src='@/assets/curso/images/tema2/img_5.png' alt='', style="width:400px; display:block; margin:-1rem 0 ;").mb-3

    p.mb-3 A continuación cuatro claves para definir estrategias de ventas para que cada vendedor pueda aplicar según sus particularidades y contexto (Pérez, 2018):
                ...
                p.mb-3 Cada vendedor debe tener claro los siguientes interrogantes, para  así poder determinar o evaluar su fuerza de ventas:
                  ul.lista-ul
                    li 
                      ...
                      | ¿Cuánto puede vender al día?
                    li
                      i.fas.fa-check.c-check
                      | ¿Cómo podría aumentar las ventas en la zona en la cual está ubicado?
                    li 
                      i.fas.fa-check.c-check
                      | ¿Qué puede hacer como vendedor para lograr más ingresos, vendiendo los productos que rotan poco?
                    li 
                      i.fas.fa-check.c-check
          ...
          .tarjeta.back-tab.px-5.py-4(titulo="Plan de acción")
            .row.px-5.py-3.justify-content-center.align-items-center
              ...
              .col-lg-8
                ...
                p.mb-3 Como también si el vendedor es ambulante, también puede variar las acciones para ejecutar cada plan. 

                p.mb-0 Apoyarse en la red comercializadora es vital para lograr los ingresos y ventas esperadas. Siguiendo las instrucciones, protocolos y recomendaciones dadas a  la fuerza de venta, más el valor agregado de cada vendedor se logra cristalizar los planes de acción exitosos. 
  ...
  data: () => ({
    datosLineaTiempoB: [
      ...
      },
      {
        titulo: '2. Interesar',
        texto:
          'Captar interés en los productos y servicios a ofrecer, puede ser mediante lanzamientos de nuevos productos, campañas, descuentos, ofertas, etc. ',
        icono: require('@/assets/curso/images/tema2/ico_2.svg'),
      },
      {
        titulo: '3. Generar deseo de compra',
        texto: 'Convencer al interesado a tomar la decisión de comprar.',
        icono: require('@/assets/curso/images/tema2/ico_3.svg'),
      },
      {
        titulo: '4. Vender',
        texto:
          'Concretar la venta, en este momento se evidencia la transacción comercial. Para este punto es importante suministrar facilidades de pago, ya sea de contado o por otro medio.',
        icono: require('@/assets/curso/images/tema2/ico_4.svg'),
      },
      {
        titulo: '5. Fidelizar',
