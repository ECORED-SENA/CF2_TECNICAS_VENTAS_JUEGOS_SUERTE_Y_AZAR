  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Conocimiento sobre las mejores prácticas de venta
        p.mb-4 Verificar conceptos generales para llevar a cabo una venta y un proceso de control efectivo y eficiente e incrementar las ventas de los vendedores.
